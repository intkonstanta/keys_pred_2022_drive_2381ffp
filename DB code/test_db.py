...
def start_a_competition(conn, name=None, date=None, organizer=None, location=None):
    sql_create_compt =""" INSERT INTO competitions (name, begin_date, organizer, location) VALUES ("{}", "{}", "{}", "{}")""".format(name, date, organizer, location)
    c = conn.cursor()
...
def add_telemetric_data(conn, ride_id='1.1', pilot='None', angle='0', velocity='0', trajectory='0'):
    sql_create_ride = """ INSERT INTO "{}" (pilot, angle, velocity, trajectory) VALUES ("{}", "{}", "{}", "{}") """.format(ride_id, pilot, angle, velocity, trajectory)
...
def start_a_ride(conn, competition_index='1', ride_type='64', pilots=[], begin_time='00:00', end_time='00:30'):
    ...
    sql_create_ride = """ INSERT INTO competition_{} (ride_type, pilots_involved, begin_time, end_time, name) VALUES ("{}", "{}", "{}", "{}", "{}") """.format(competition_index, types[ride_type], pilots, begin_time, end_time, (str(competition_index)+'.'+str(get_ride_id(conn, competition_index))))
